...
# Author     : team 42
# Tool       : scanner
# Usage      : python3 scanner.py example.com
...
def helper():
        ...
        print("\t./scanner.py example.com --skip dmitry --skip theHarvester: Skip the 'dmitry' and 'theHarvester' tests.")
        print("\t./scanner.py example.com --nospinner: Disable the idle loader/spinner.")
